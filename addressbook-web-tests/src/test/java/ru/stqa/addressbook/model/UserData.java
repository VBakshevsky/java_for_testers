...
public record UserData(String id, String firstname, String middlename, String lastname, String nickname, String title,
    ...
    public UserData withPhotoAndDays(String bday, String aday, String photo) {
        return new UserData(this.id, this.firstname, this.middlename, this.lastname, this.nickname, this.title, this.company, this.address, this.home, this.mobile, this.work, this.fax, this.email, this.email2, this.email3, this.homepage, bday, this.bmonth, this.byear, aday, this.amonth, this.ayear, photo);
    }
    public UserData withAllInformation(String id, String firstname, String middlename, String lastname, String nickname, String title, String company, String address, String home, String mobile, String work, String fax, String email, String email2, String email3, String homepage, String bmonth, String byear, String amonth, String ayear) {
        return new UserData(id, firstname, middlename, lastname, nickname, title, company, address, home, mobile, work, fax, email, email2, email3, homepage, this.bday, bmonth, byear, this.aday, amonth, ayear, this.photo);
    }
    ...
    public UserData withMainInformation(String firstname, String middlename, String lastname, String address, String email, String email2, String email3, String mobile, String photo) {
        return new UserData(this.id, firstname, middlename, lastname, this.nickname, this.title, this.company, address, this.home, mobile, this.work, this.fax, email, email2, email3, this.homepage, this.bday, this.bmonth, this.byear, this.aday, this.amonth, this.ayear, photo);
    }
}